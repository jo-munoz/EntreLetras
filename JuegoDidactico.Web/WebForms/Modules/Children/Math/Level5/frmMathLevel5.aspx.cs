...
namespace JuegoDidactico.Web.WebForms.Modules.Children.Math.Level5
{
    public partial class frmMathLevel5 : System.Web.UI.Page
    {
        ...
        protected void btnLevel5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (rbtn3_1.Checked == false && rbtn3_2.Checked == false && rbtn3_3.Checked == false)
                {
                    Response.Write("<Script Language='JavaScript'>parent.alert('" + "Seleccione respuesta de la tercera pregunta" + "');</Script>");
                }
                else
                {
                    if (rbtn1_3.Checked == true && rbtn2_1.Checked == true && rbtn3_2.Checked == true)
                    {
                        doPuntaje = 100;
                    }
                    ...
                    {
                        //Inserto el Avance
                        stLevelInsert = csLevel.stLevelInsert(Session["Cod_user"].ToString().Trim(), "Level5", Convert.ToString(doPuntaje).Trim(), "Math");
                        if (stLevelInsert == "Se inserto con exito")
                        {
                            Session["LevelPassedMath"] = "Level5";
