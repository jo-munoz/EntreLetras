<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Children.Master" AutoEventWireup="true" CodeBehind="frmSelectLevel.aspx.cs" Inherits="JuegoDidactico.Web.WebForms.frmSelectLevel" %>
                ...
                <div class="col-10 rounded bg-light">
                    <div class="row justify-content-center mt-3 mb-3 ">
                        <div class="col-10 text-center">
                            <h1>Niveles de Español:</h1>
                            <h3>Seleccione Nivel</h3>
                        </div>
                    </div>
                    ...
                    <div class="row border-0 rounded justify-content-center mb-5">
                        ...
                        <div class="col-2 d-flex img-fluid rounded align-items-center text-center mx-4 bg-info">
                            <figure class="figure">
                                ...
                                <asp:ImageButton ID="UnlockedLevel2" runat="server" CssClass="img-fluid mt-2" src="../../../../Images/two.png" alt="" Width="60%" Height="60%" Visible="false" Style="cursor: pointer;" OnClick="UnlockedLevel2_Click" />
                            </figure>
                        </div>
                        <div class="col-2 d-flex img-fluid rounded align-items-center text-center bg-info">
                            <figure class="figure">
                                ...
                                <asp:ImageButton ID="UnlockedLevel3" runat="server" CssClass="img-fluid mt-2" src="../../../../Images/three.png" alt="" Width="50%" Height="50%" Visible="false" Style="cursor: pointer;" OnClick="UnlockedLevel3_Click" />
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="row border-0 rounded justify-content-center mb-4">
                        <div class="col-2 d-flex img-fluid rounded align-items-center text-center bg-info">
                            <figure class="figure">
                                ...
                                <asp:ImageButton ID="UnlockedLevel4" runat="server" CssClass="img-fluid mt-2" src="../../../../Images/four.png" alt="" Width="50%" Height="50%" Visible="false" Style="cursor: pointer;" OnClick="UnlockedLevel4_Click" />
                            </figure>
                        </div>
                        <div class="col-2 d-flex img-fluid rounded align-items-center text-center mx-4 bg-info">
                            <figure class="figure">
                                ...
                                <asp:ImageButton ID="UnlockedLevel5" runat="server" CssClass="img-fluid mt-2" src="../../../../Images/five.png" alt="" Width="50%" Height="50%" Visible="false" Style="cursor: pointer;" OnCommand="UnlockedLevel5_Command" />
                            </figure>
                        </div>
                        <div class="col-2 d-flex img-fluid rounded align-items-center text-center bg-info">
                            <figure class="figure">
