...
{
    public partial class frmSpanishLevel5Question2 : System.Web.UI.Page
    {
        ...
        protected void btnLevel5Question2_Click(object sender, EventArgs e)
        {
            int inPuntaje = 0;
            ...
            else
            {
                ...
                {
                    //Inserto el Avance
                    stLevelInsert = csLevel.stLevelInsert(Session["Cod_user"].ToString().Trim(), "Level5", Convert.ToString(inPuntajeTotal).Trim(), "Spanish");
                    if (stLevelInsert == "Se inserto con exito")
                    {
                        Session["LevelPassedSpanish"] = "Level5";
                        Response.Redirect("~/WebForms/Modules/Children/Spanish/frmSelectLevel.aspx", false);
                    }
                }
            }
