...
{
    public partial class frmSpanishLevel4Question2 : System.Web.UI.Page
    {
        ...
        protected void btnLevel4Question2_Click(object sender, EventArgs e)
        {
            int inPuntaje = 0;
            ...
            else
            {
                ...
                {
                    //Inserto el Avance
                    stLevelInsert = csLevel.stLevelInsert(Session["Cod_user"].ToString().Trim(), "Level4", Convert.ToString(inPuntajeTotal).Trim(), "Spanish");
                    if (stLevelInsert == "Se inserto con exito")
                    {
                        Session["LevelPassedSpanish"] = "Level4";
                        Response.Redirect("~/WebForms/Modules/Children/Spanish/frmSelectLevel.aspx", false);
                    }
                }
            }
